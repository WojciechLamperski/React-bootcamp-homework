...
- zadbaj o stylowanie aplikacji wykorzystując `StyledComponents`
- utwórz przełącznik: `tryb ciemny / jasny` dla całej strony

## Zadanie 4

- dodaj do komponentu przycisk `Delete` i napisz jego obsługę

## Zadanie 5

- umieść powyżej listy osób filtr umożliwiający wyszukiwanie osób po imieniu
